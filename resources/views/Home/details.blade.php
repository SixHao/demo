...
@endsection
		...
		<script type="text/javascript" src="{{ asset('/Home/js/jquery-1.8.3.js') }}"></script>
...
@section('content')
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="{{asset('/uploads/default.jpg')}}" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
					        ...
					        <div style="width: 300px"><small>{{$data->gdesc}}</small></div>
						</div>
        ...
        $("#ldiv").on("mousemove", function(e){
            ...
            // 获取 ldiv的偏移量。
            var ldivLeft = $("#ldiv").offset().left;
            // console.log(ldivLeft);
            var ldivTop = $("#ldiv").offset().top;

            // 计算。
            var mLeft = mouseX - ldivLeft - mW/2;
            var mTop = mouseY - ldivTop - mH/2;
            ...
            // 设置move 的 left top
            $("#move").css({left:mLeft+ 'px', top: mTop+ 'px'});
            ...
            var rImgLeft = rImgW*rImgLP;
            var rImgTop = rImgH*rImgTP;

            // 设置大图。
            $("#rimg").css({left:-rImgLeft + 'px',top:-rImgTop + 'px'});

        });


        $("#ldiv").on("mouseout", function(e){
            // console.log(222);
            // 让 move 隐藏。
        ...
        $("#uid img").on('mouseover', function(){
            ...
            $("#rimg").attr('src', src);
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<input id="text_box" name="bcnt" type="text" value="1" style="width:30px;" />
													...
													<script>
														...
														jia.onclick = function(){ 
															if(num.value>={{$data->stock}}){
																num.value = {{$data->stock}}-1;
															}
														}
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="javascript:;" onclick="add({{$data->gid}})"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
					</div>
					...
					<script type="text/javascript">
						...
						{
							tocart.href = tocart.href + '&bcnt=' + num.value;
						}
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li title="">上架时间:&nbsp;{{date('Y-m-d',$data->ctime)}}</li>
									...
									<div class="details">
										...
										<p style="font-size: 24px;margin: 20px 0px; text-indent: 2em; line-height: 1.5em; text-align: left; color: red;">{{$data->gdesc}}</p>
