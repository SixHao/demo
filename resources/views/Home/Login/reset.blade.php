        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
                ...
                <div class="part2" style="display:block">
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>用户号：</span>    
                        <div class="f-fl item-ifo">
                            <input class="username" type="text" size="40" maxlength="40" class="txt03 f-r3 required" tabindex="1"   data-valid="isNonEmpty" id="adminNo"  name="username" placeholder="请输入邮箱"/>                   <span class="ie8 icon-close close hide"></span>
                            <label class="icon-sucessfill blank hide"></label>
                            <label class="focus"><span></span></label>
                            <label class="focus valid"></label>
                        </div>
                	   ...
                	   <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input size="36" type="password" class="newpwd" id="password" maxlength="20" class="txt03 f-r3 required" tabindex="3" style="ime-mode:disabled;" onpaste="return  false" autocomplete="off" data-valid="isNonEmpty||between:6-20||level:2" data-error="密码不能为空||密码长度6-20位||该密码太简单，有被盗风险，建议字母+数字的组合" /> 
                ...
                <div class="part4 text-center" style="display:none">
                    ...
                    <p class="c-666 f-mt30 f-mb50">页面将在 <strong id="times" class="f-size18">3</strong> 秒钟后，跳转到<a href="{{url('/home/login/login/')}}" class="c-blue">登录页面</a></p>
                </div>          
            </div>
        </div>
    </div>
...
$(function(){   
    ...
    $("#btn_part2").on('click',function()
    {
        ...
        $.ajax(
            {
                url:'/home/login/doreset',
                type:'post',
                data:{password:password,username:username,"_token":"{{ csrf_token() }}"},
