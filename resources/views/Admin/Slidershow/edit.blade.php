                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{ url('/admin/slidershow/update').'/'.$data->bid }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="请输入您想链接的地址" name="url" value="{{$data->url}}">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">图片顺序 <span class="tpl-form-line-small-title">order</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="请输入您想放置图片的顺序" name="order" value="{{$data->order}}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    ...
                                                    <img id="imghead" width="700px" height="500px" src="{{$data->src}}" \>
                                                </div>
