                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a style="color: white" href="{{ url('/admin/permission/create') }}"> 添加权限</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <div class="tpl-table-black-operation">
                                                ...
                                                <a href="javascript:;" onclick="urlDel({{$v->pid}})" class="tpl-table-black-operation-del">
...
//                $.get("请求服务器的路径","携带的参数", 获取执行成功后的额返回数据);
            //admin/user/1
            $.post("{{url('/admin/permission')}}/"+pid,{"_method":"delete","_token":"{{ csrf_token() }}"},function(data){
