                ...
                <div class="row">
                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="am-u-sm-12">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{ url('/admin/config/insert') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" class="tpl-form-input" id="user-name" placeholder="请输入配置内容" name="wcontent" value="{{ old('wcontent') }}" ></textarea>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div>
                                         <input type="radio" name="wtype" value="input"  checked onclick="showTr(this)">input
                                         <input type="radio" name="wtype" value="textarea" onclick="showTr(this)">textarea
                                         <input type="radio" name="wtype" value="radio" onclick="showTr(this)">radio
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text"  id="user-name" placeholder="请输入类型值" name="wvalue"  value="{{ old('wvalue') }}">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入数字排序" name="worder"  value="{{ old('worder') }}">
                                        </div>
                                    </div>
                                      <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">配置说明: <span class="tpl-form-line-small-title">wtips</span></label>
                                        <div class="am-u-sm-9">
                                            <textarea type="text" class="tpl-form-input" id="user-name" placeholder="请输入说明" name="wtips"  value="{{ old('wtips') }}"></textarea>
                                        </div>
                                    </div>
